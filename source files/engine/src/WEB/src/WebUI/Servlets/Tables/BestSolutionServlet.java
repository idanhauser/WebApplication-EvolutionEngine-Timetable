...
@WebServlet( name = "BestSolutionServlet", urlPatterns = {"/BestSolution"} )
public class BestSolutionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter())
        {
            ...
            DTOEngineInformation<Quintet> engineDto = engine.getDTOEngine();
            //BestSolutionDTO temp = new BestSolutionDTO(engineDto.getBestFitnessint(),engineDto.getGenerationCount());
            BestSolutionDTO temp = new BestSolutionDTO(engine.getMaxFitness(),engineDto.getGenerationCount());
