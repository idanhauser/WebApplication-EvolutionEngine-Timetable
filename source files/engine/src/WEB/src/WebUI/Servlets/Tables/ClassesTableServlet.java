...
@WebServlet( name = "ClassesTableServlet", urlPatterns = {"/ClassesTable"} )
public class ClassesTableServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Map<Integer, StudyClass> studyClasses = engine.getTimeTable().getStudyClasses();
            String json = gson.toJson(studyClasses);
            out.println(json);
            out.flush();
        }
        catch (Exception e)
