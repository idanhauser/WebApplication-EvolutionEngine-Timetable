...
@WebServlet( name = "SubjectsTableServlet", urlPatterns = {"/SubjectsTable"} )
public class SubjectsTableServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Map<Integer, Subject> subjects = engine.getTimeTable().getSubjects();
