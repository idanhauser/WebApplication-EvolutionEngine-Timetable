...
public class usersAndEnginesServlet extends HttpServlet {

    private final String USERS_STOCKS_URL = "../UsersHomePage/usersHome.html";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String json = gson.toJson(clientList.getUsernameList());
            out.println(json);
            out.flush();
        }
        catch (Exception e)
