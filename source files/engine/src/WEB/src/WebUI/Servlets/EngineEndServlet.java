...
@WebServlet( name = "EngineEndServlet", urlPatterns = {"/IsEngineEnd"} )
public class EngineEndServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            boolean isEnd = engine.EndFlagStatus();
            String json = gson.toJson(isEnd);
            out.println(json);
            out.flush();
        }
        catch (Exception e)
