...
public class TimeTable implements Serializable {
    ...
    private int m_SubjectsLen;
    private int m_StudyClassesLen;
    private int m_TeachersLen;
    ...
    public TimeTable(LoadData i_LoadData) {
        ...
        this.m_SubjectsLen = m_Subjects.size();
        this.m_StudyClasses = i_LoadData.getStudyClasses();
        this.m_StudyClassesLen = m_StudyClasses.size();
        this.m_Teachers = LoadData.getTeachers();
        this.m_TeachersLen = m_Teachers.size();
