...
/*    public Selection(ETTSelection i_EttSelection, int i_PopSize) {
    ...
    public Selection(int i_InitialPopulation, String i_Selection, String i_Elitism, String i_Probability) {
        setElitismCount(i_Elitism, i_InitialPopulation);
        m_EnumSelectType = type.valueOf(i_Selection);
        setTopPercent(Float.parseFloat(i_Probability));
    ...
    private void chooseElitism(List<Individual> i_Individuals, List<Individual> i_IndividualsWithoutElite) {
        ...
        m_ElitismList.addAll(i_Individuals.subList(0, m_ElitismCount-1));
    ...
    public enum type implements Serializable {
        ...
        RouletteWheel {
            ...
            public List<Individual> RouletteWheel(List<Individual> i_individuals) {
                ...
                for (int i = 0; i < i_individuals.size()-1; i++) {
