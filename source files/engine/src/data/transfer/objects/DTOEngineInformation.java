...
public class DTOEngineInformation<T> implements Serializable {
    ...
    private int m_BestFitnessint=0;
    private int m_BestGen = 0;
    ...
    public DTOEngineInformation(DTOEngineInformation<Quintet> dtoEngine) {
        ...
        m_BestFitness.setValue(dtoEngine.getBestFitness().getValue());
    ...
    public void setBestFitnessint(int i_BestFitnessint) {
        this.m_BestFitnessint = i_BestFitnessint;
    }
    ...
    public void setGenerationCount(int i_GenerationCount) {
        m_GenerationCount=i_GenerationCount;
    }

    public int getBestFitnessint() {
        return m_BestFitnessint;
    }
}
